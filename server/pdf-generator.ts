...
export async function generatePDFFromHTML(
  ...
  try {
    ...
    // If HTML content is provided, create a simple PDF with the title and content
    if (htmlContent) {
      console.log('Generating creative PDF report...');
      const doc = new jsPDF({
      ...
      // Add title
      doc.setFontSize(24);
      doc.setTextColor(16, 163, 127); // Emerald color
      doc.text(audit.name || 'Creative Safety Report', 20, 30);

      // Add subtitle
      doc.setFontSize(16);
      doc.setTextColor(75, 85, 99); // Gray color
      doc.text(audit.description || 'Your personalized home protection plan', 20, 45);
      ...
      const sections = [
        'Hero Section: Your home\'s protection journey begins here',
        'Current Status: Protection level assessment and vulnerabilities',
        'Timeline: Seasonal risk patterns and preparation schedule',
        'Success Story: Transformation through safety improvements',
        'Action Plan: 90-day roadmap with prioritized steps',
        'Resources: Emergency contacts and preparation materials'
      ];
